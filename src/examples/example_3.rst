...
:Revision: $Revision: 8176 $
:Date: $Date: 2017-09-07 20:00:57 +0000 (Thu, 07 Sep 2017) $
...
A text block which begins with a "*", "+", "-", "â˘", "âŁ", or "â",
...
- "*" '|' (*) [*] {*} <*>
  â*â â*â â*â â*â â*â
  â*â â*â â*â â*â â*â
  Âť*ÂŤ âş*âš ÂŤ*Âť Âť*Âť âş*âş (breaks rule 5)
