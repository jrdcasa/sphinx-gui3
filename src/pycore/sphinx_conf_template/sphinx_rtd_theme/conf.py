...
# -*- coding: utf-8 -*-
#
# loge documentation build configuration file, created by
# sphinx-quickstart on Thu Sep 14 21:57:45 2017.
#
...
MOCK_MODULES = ['pandas', 'networkx', 'matplotlib', 'numpy', 'scipy', 'h5py', 'ext_libc',
                'ext_libc.c_discriminant', 'numpy.core', 'numpy.core._multiarray_umath']
...
pdf_documents = [
    ('index', u'PDFFILEMANE', u'FIRSTPAGETITLE', u'FIRSTPAGEAUTHOR'),
]
...
pdf_cover_template = 'tebecover.tmpl'
